...
def optimize_ei_random(gp, y_target, xi=0.0001, num_restarts_ei=3, num_init=1024):
    ...
    X_best = X_rand[top_inds, :]

    return X_best


def optimize_ei_local_search(gp, y_target, xi=0.0, num_restarts_ei=5, num_init=5000):
